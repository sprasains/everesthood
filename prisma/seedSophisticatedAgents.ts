...
const sophisticatedAgents = [
  {
    ...
    description: "Advanced data analysis and business intelligence agent with multi-source data integration",
    defaultPrompt: "You are an enterprise data analyst. Analyze complex datasets, create visualizations, and provide actionable business insights.",
    defaultModel: "gpt-4o",
    category: "Analytics",
    credentials: {
    ...
    workflows: {
      dataCollection: {
        steps: ["connect_sources", "validate_data", "transform_data", "load_warehouse"],
        triggers: ["scheduled", "manual", "event_driven"]
      },
      analysis: {
        steps: ["exploratory_analysis", "statistical_testing", "trend_identification", "anomaly_detection"],
  ...
  },
  {
    ...
    defaultPrompt: "You are an AI research scientist. Conduct research, develop models, and advance AI capabilities.",
    defaultModel: "gpt-4o",
    category: "AI",
    credentials: {
    ...
    workflows: {
      research: {
        steps: ["literature_review", "hypothesis_formulation", "experiment_design", "model_development"],
  ...
  },
  {
    ...
    defaultPrompt: "You are a cybersecurity threat hunter. Detect, analyze, and respond to security threats.",
    defaultModel: "gpt-4o",
    category: "Security",
    credentials: {
    ...
    workflows: {
      threatHunting: {
        steps: ["log_analysis", "pattern_recognition", "threat_correlation", "incident_response"],
  ...
  },
  {
    ...
    description: "Quantum algorithm development and quantum computing research agent",
    defaultPrompt: "You are a quantum computing specialist. Develop quantum algorithms and optimize quantum circuits.",
    defaultModel: "gpt-4o",
    category: "Quantum",
    credentials: {
      required: ["quantum_simulator", "quantum_hardware", "algorithm_libraries"],
      optional: ["research_grants", "academic_access"]
    },
    workflows: {
      quantumDevelopment: {
        steps: ["problem_analysis", "quantum_mapping", "circuit_design", "optimization"],
  ...
  },
  {
    ...
    description: "Smart contract development and blockchain infrastructure design agent",
    defaultPrompt: "You are a blockchain architect. Design and develop smart contracts and blockchain solutions.",
    defaultModel: "gpt-4o",
    category: "Blockchain",
    credentials: {
    ...
    workflows: {
      smartContractDev: {
        steps: ["requirements_analysis", "contract_design", "development", "testing", "deployment"],
  ...
  },
  {
    ...
    description: "Internet of Things device management and data processing agent",
    defaultPrompt: "You are an IoT platform manager. Manage devices, process sensor data, and optimize IoT networks.",
    defaultModel: "gpt-4o",
    category: "IoT",
    credentials: {
    ...
    workflows: {
      deviceManagement: {
        steps: ["device_onboarding", "data_collection", "processing", "analytics"],
  ...
  },
  {
    ...
    description: "CI/CD pipeline automation and infrastructure management agent",
    defaultPrompt: "You are a DevOps automation engineer. Automate deployments, manage infrastructure, and optimize workflows.",
    defaultModel: "gpt-4o",
    category: "DevOps",
    credentials: {
    ...
    workflows: {
      deployment: {
        steps: ["code_analysis", "testing", "building", "deployment", "monitoring"],
  ...
  },
  {
    ...
    description: "ML model deployment, monitoring, and lifecycle management agent",
    defaultPrompt: "You are an MLOps engineer. Deploy, monitor, and maintain machine learning models in production.",
    defaultModel: "gpt-4o",
    category: "MLOps",
    credentials: {
      required: ["model_registry", "monitoring_platform", "deployment_platform"],
      optional: ["feature_store", "experiment_tracking"]
    },
    workflows: {
      modelLifecycle: {
        steps: ["model_training", "validation", "deployment", "monitoring", "retraining"],
  ...
  },
  {
    ...
    defaultPrompt: "You are an NLP expert. Develop language models, analyze text, and build conversational AI.",
    defaultModel: "gpt-4o",
    category: "NLP",
    credentials: {
    ...
    workflows: {
      textAnalysis: {
        steps: ["preprocessing", "feature_extraction", "model_training", "evaluation"],
        outputs: ["sentiment_analysis", "entity_recognition", "text_classification"]
      }
    },
  ...
  },
  {
    ...
    description: "Image and video processing, object detection, and computer vision agent",
    defaultPrompt: "You are a computer vision engineer. Process images, detect objects, and build vision-based AI systems.",
    defaultModel: "gpt-4o",
    ...
    workflows: {
      imageProcessing: {
        steps: ["image_preprocessing", "feature_extraction", "object_detection", "classification"],
    ...
    metadata: {
      complexity: "Advanced",
      applications: ["object_detection", "facial_recognition", "medical_imaging"]
    }
  },
  {
    name: "Robotics Control Systems Engineer",
    description: "Robot programming, control systems, and automation agent",
    defaultPrompt: "You are a robotics control systems engineer. Program robots, design control systems, and optimize automation.",
    defaultModel: "gpt-4o",
    category: "Robotics",
    credentials: {
    ...
    workflows: {
      robotControl: {
        steps: ["sensor_fusion", "path_planning", "motion_control", "collision_avoidance"],
  ...
  },
  {
    ...
    defaultPrompt: "You are an AR developer. Create immersive AR experiences and spatial computing applications.",
    defaultModel: "gpt-4o",
    category: "AR/VR",
    credentials: {
    ...
    workflows: {
      arDevelopment: {
        steps: ["environment_mapping", "content_creation", "interaction_design", "testing"],
  ...
  },
  {
    ...
    defaultPrompt: "You are an edge computing specialist. Optimize edge devices and manage distributed computing resources.",
    defaultModel: "gpt-4o",
    ...
    workflows: {
      edgeOptimization: {
        steps: ["resource_allocation", "load_balancing", "latency_optimization", "power_management"],
  ...
  },
  {
    ...
    defaultPrompt: "You are a digital twin architect. Create and manage digital twins for physical systems and processes.",
    defaultModel: "gpt-4o",
    ...
    workflows: {
      twinCreation: {
        steps: ["system_modeling", "data_integration", "simulation_setup", "real_time_sync"],
        outputs: ["digital_twins", "predictive_analytics", "optimization_insights"]
      }
    },
    connectors: ["ansys", "simulink", "azure_digital_twins", "aws_iot_twinmaker"],
    metadata: {
      complexity: "Advanced",
  ...
  },
  {
    ...
    defaultPrompt: "You are a federated learning coordinator. Manage distributed ML training while preserving data privacy.",
    defaultModel: "gpt-4o",
    ...
    workflows: {
      federatedTraining: {
        steps: ["node_registration", "model_distribution", "local_training", "secure_aggregation"],
    ...
    metadata: {
      complexity: "Advanced",
      privacyTechniques: ["differential_privacy", "homomorphic_encryption", "secure_aggregation"]
    }
  },
  {
    name: "Autonomous Vehicle Systems Engineer",
    description: "Self-driving car systems and autonomous navigation agent",
    defaultPrompt: "You are an autonomous vehicle systems engineer. Develop self-driving systems and navigation algorithms.",
    defaultModel: "gpt-4o",
    ...
    workflows: {
      autonomousNavigation: {
        steps: ["sensor_fusion", "localization", "path_planning", "motion_control"],
  ...
  },
  {
    ...
    description: "Urban infrastructure monitoring and smart city optimization agent",
    defaultPrompt: "You are a smart city infrastructure manager. Monitor and optimize urban systems and infrastructure.",
    defaultModel: "gpt-4o",
    ...
    workflows: {
      infrastructureManagement: {
        ...
        outputs: ["efficiency_reports", "maintenance_alerts", "optimization_plans"]
      }
    },
    connectors: ["siemens_mindsphere", "ibm_watson_iot", "cisco_kinetic"],
    metadata: {
      complexity: "Advanced",
      systems: ["traffic_management", "energy_grid", "waste_management", "public_safety"]
    }
  },
  {
    name: "Healthcare AI Specialist",
    description: "Medical AI development and healthcare analytics agent",
    defaultPrompt: "You are a healthcare AI specialist. Develop AI solutions for medical diagnosis and healthcare optimization.",
    defaultModel: "gpt-4o",
    category: "Healthcare",
    credentials: {
    ...
    workflows: {
      medicalAI: {
        steps: ["data_validation", "model_development", "clinical_validation", "regulatory_approval"],
        outputs: ["diagnostic_tools", "treatment_recommendations", "clinical_reports"]
      }
    },
  ...
  },
  {
    ...
    defaultPrompt: "You are a FinTech architect. Design and develop financial technology solutions and integrations.",
    defaultModel: "gpt-4o",
    category: "FinTech",
    credentials: {
      required: ["banking_apis", "regulatory_compliance", "security_certifications"],
      optional: ["blockchain_platforms", "ai_trading_systems"]
    },
    workflows: {
      fintechDevelopment: {
        steps: ["requirements_analysis", "security_design", "development", "compliance_testing"],
        outputs: ["financial_applications", "api_integrations", "compliance_reports"]
      }
    },
  ...
  },
  {
    ...
    defaultPrompt: "You are a supply chain optimization engineer. Analyze and optimize supply chain operations and logistics.",
    defaultModel: "gpt-4o",
    ...
    workflows: {
      supplyChainOptimization: {
        steps: ["demand_forecasting", "inventory_optimization", "route_planning", "cost_analysis"],
    ...
    metadata: {
      complexity: "Advanced",
      optimizationAreas: ["inventory", "transportation", "warehousing", "procurement"]
    }
  },
  {
    name: "Energy Grid Management Specialist",
    description: "Smart grid optimization and renewable energy integration agent",
    defaultPrompt: "You are an energy grid management specialist. Optimize power grids and integrate renewable energy sources.",
    defaultModel: "gpt-4o",
    category: "Energy",
    credentials: {
  ...
  },
  {
    ...
    defaultPrompt: "You are an environmental monitoring scientist. Analyze environmental data and monitor climate changes.",
    defaultModel: "gpt-4o",
    ...
    workflows: {
      environmentalAnalysis: {
        steps: ["data_collection", "quality_assurance", "trend_analysis", "prediction_modeling"],
        outputs: ["environmental_reports", "climate_predictions", "alert_systems"]
      }
    },
    connectors: ["nasa_apis", "noaa_data", "epa_systems", "sentinel_satellites"],
    metadata: {
      complexity: "Advanced",
      monitoringAreas: ["air_quality", "water_quality", "biodiversity", "climate_change"]
    }
  },
  {
    name: "Space Systems Engineer",
    description: "Satellite systems and space technology development agent",
    defaultPrompt: "You are a space systems engineer. Design and manage satellite systems and space technologies.",
    defaultModel: "gpt-4o",
    category: "Space",
    credentials: {
    ...
    workflows: {
      satelliteOperations: {
        steps: ["orbit_planning", "payload_operations", "data_downlink", "system_maintenance"],
    ...
    metadata: {
      complexity: "Advanced",
      satelliteTypes: ["communication", "earth_observation", "navigation", "scientific"]
    }
  },
  {
    name: "Quantum Machine Learning Researcher",
    description: "Quantum machine learning algorithms and hybrid quantum-classical systems agent",
    defaultPrompt: "You are a quantum machine learning researcher. Develop quantum ML algorithms and hybrid systems.",
    defaultModel: "gpt-4o",
    category: "Quantum ML",
    credentials: {
    ...
    metadata: {
      complexity: "Advanced",
      applications: ["quantum_neural_networks", "quantum_kernels", "quantum_optimization"]
    }
  },
  {
    name: "Neuromorphic Computing Specialist",
    description: "Brain-inspired computing and neuromorphic hardware agent",
    defaultPrompt: "You are a neuromorphic computing specialist. Develop brain-inspired computing systems and algorithms.",
    defaultModel: "gpt-4o",
    category: "Neuromorphic",
    credentials: {
      required: ["neuromorphic_hardware", "spiking_neural_networks", "brain_data"],
    ...
    metadata: {
      complexity: "Advanced",
      applications: ["edge_ai", "cognitive_computing", "brain_computer_interfaces"]
    }
  },
  {
    name: "Bioinformatics Data Scientist",
    description: "Genomic data analysis and biological computing agent",
    defaultPrompt: "You are a bioinformatics data scientist. Analyze genomic data and develop biological computing solutions.",
    defaultModel: "gpt-4o",
    category: "Bioinformatics",
    credentials: {
      required: ["genomic_databases", "sequencing_data", "biological_databases"],
      optional: ["clinical_data", "drug_databases"]
    },
    workflows: {
      genomicAnalysis: {
        steps: ["sequence_alignment", "variant_calling", "functional_annotation", "pathway_analysis"],
    ...
    metadata: {
      complexity: "Advanced",
      applications: ["precision_medicine", "drug_discovery", "disease_mechanisms"]
    }
  },
  {
    name: "Digital Forensics Expert",
    description: "Digital evidence analysis and cybersecurity forensics agent",
    defaultPrompt: "You are a digital forensics expert. Analyze digital evidence and conduct cybersecurity investigations.",
    defaultModel: "gpt-4o",
    ...
    workflows: {
      forensicInvestigation: {
        steps: ["evidence_collection", "preservation", "analysis", "documentation"],
    ...
    metadata: {
      complexity: "Advanced",
      evidenceTypes: ["disk_forensics", "memory_forensics", "network_forensics", "mobile_forensics"]
    }
  },
  {
    name: "Game AI Developer",
    description: "Game artificial intelligence and procedural content generation agent",
    defaultPrompt: "You are a game AI developer. Create intelligent game systems and procedural content generation.",
    defaultModel: "gpt-4o",
    category: "Game AI",
    credentials: {
    ...
    workflows: {
      gameAIDevelopment: {
        steps: ["behavior_design", "pathfinding", "decision_trees", "content_generation"],
    ...
    metadata: {
      complexity: "Intermediate",
      aiTypes: ["npc_behavior", "procedural_generation", "adaptive_difficulty", "player_modeling"]
    }
  },
  {
    name: "Social Media Analytics Expert",
    description: "Social media data analysis and trend prediction agent",
    defaultPrompt: "You are a social media analytics expert. Analyze social media data and predict trends.",
    defaultModel: "gpt-4o",
    ...
    workflows: {
      socialAnalytics: {
        steps: ["data_collection", "sentiment_analysis", "trend_identification", "prediction_modeling"],
        outputs: ["trend_reports", "sentiment_analysis", "engagement_metrics"]
      }
    },
    connectors: ["twitter_api", "facebook_api", "instagram_api", "linkedin_api"],
    metadata: {
      complexity: "Intermediate",
      analyticsAreas: ["sentiment_analysis", "trend_prediction", "influencer_identification", "brand_monitoring"]
    }
  },
  {
    name: "Creative AI Artist",
    description: "AI-powered creative content generation and artistic collaboration agent",
    defaultPrompt: "You are a creative AI artist. Generate artistic content and collaborate with human artists.",
    defaultModel: "gpt-4o",
    ...
    workflows: {
      creativeGeneration: {
        steps: ["style_analysis", "content_generation", "refinement", "collaboration"],
    ...
    metadata: {
      complexity: "Intermediate",
      creativeDomains: ["visual_art", "music", "writing", "design", "animation"]
    }
  },
  {
    name: "Educational Technology Specialist",
    description: "AI-powered education and personalized learning agent",
    defaultPrompt: "You are an educational technology specialist. Create personalized learning experiences and educational content.",
    defaultModel: "gpt-4o",
    category: "EdTech",
    credentials: {
    ...
    workflows: {
      personalizedLearning: {
        steps: ["student_assessment", "content_adaptation", "progress_tracking", "intervention"],
    ...
    metadata: {
      complexity: "Intermediate",
      learningTypes: ["adaptive_learning", "gamification", "virtual_reality", "augmented_reality"]
    }
  },
  {
    name: "Legal AI Assistant",
    description: "Legal document analysis and contract review agent",
    defaultPrompt: "You are a legal AI assistant. Analyze legal documents and assist with contract review.",
    defaultModel: "gpt-4o",
    category: "Legal AI",
    credentials: {
      required: ["legal_databases", "document_analysis", "compliance_frameworks"],
      optional: ["case_law", "regulatory_updates"]
    },
    workflows: {
      legalAnalysis: {
        steps: ["document_review", "risk_assessment", "compliance_checking", "recommendation_generation"],
    ...
    metadata: {
      complexity: "Advanced",
      legalAreas: ["contract_law", "compliance", "intellectual_property", "employment_law"]
    }
  }
];
