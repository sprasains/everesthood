...
const advancedAgents = [
  {
    ...
    description:
      'Advanced multimodal AI systems integrating text, vision, audio, and sensor data',
    defaultPrompt:
      'You are a multimodal AI architect. Design and implement systems that process and integrate multiple data modalities simultaneously.',
    defaultModel: 'gpt-4o',
  ...
  },
  {
    ...
    description:
      'Intelligent drone fleet management and autonomous aerial operations',
    defaultPrompt:
      'You are an autonomous drone fleet controller. Manage multiple drones for surveillance, delivery, and aerial operations.',
    defaultModel: 'gpt-4o',
  ...
  },
  {
    ...
    defaultPrompt:
      'You are a quantum cryptography specialist. Implement quantum-safe cryptographic protocols and post-quantum security.',
    defaultModel: 'gpt-4o',
  ...
  },
  {
    ...
    defaultPrompt:
      'You are a brain-computer interface engineer. Develop systems for direct neural communication and control.',
    defaultModel: 'gpt-4o',
  ...
  },
  {
    ...
    defaultPrompt:
      'You are a synthetic biology designer. Create genetic circuits and biological systems using AI-driven design.',
    defaultModel: 'gpt-4o',
  ...
  },
  {
    ...
    defaultPrompt:
      'You are an autonomous underwater vehicle controller. Manage AUVs for deep sea exploration and research.',
    defaultModel: 'gpt-4o',
  ...
  },
  {
    ...
    defaultPrompt:
      'You are a holographic display engineer. Create immersive 3D holographic experiences and spatial computing systems.',
    defaultModel: 'gpt-4o',
  ...
  },
  {
    ...
    description:
      'Quantum network infrastructure and quantum internet protocols',
    defaultPrompt:
      'You are a quantum internet architect. Design and implement quantum network infrastructure and protocols.',
    defaultModel: 'gpt-4o',
  ...
  },
  {
    ...
    description:
      'Intelligent mining automation and resource extraction optimization',
    defaultPrompt:
      'You are an autonomous mining operations manager. Optimize mining operations using AI and automation.',
    defaultModel: 'gpt-4o',
  ...
  },
  {
    ...
    defaultPrompt:
      'You are a synthetic data generation specialist. Create high-quality synthetic datasets for AI training and privacy protection.',
    defaultModel: 'gpt-4o',
  ...
  },
  {
    ...
    defaultPrompt:
      'You are an autonomous agricultural systems engineer. Optimize farming operations using AI and robotics.',
    defaultModel: 'gpt-4o',
  ...
  },
  {
    ...
    description:
      'Quantum-enhanced machine learning and quantum neural networks',
    defaultPrompt:
      'You are a quantum machine learning engineer. Develop quantum-enhanced ML algorithms and quantum neural networks.',
    defaultModel: 'gpt-4o',
    category: 'Quantum ML',
    credentials: {
      required: [
  ...
  },
  {
    ...
    defaultPrompt:
      'You are an autonomous construction manager. Optimize construction processes using AI and robotics.',
    defaultModel: 'gpt-4o',
  ...
  },
  {
    ...
    defaultPrompt:
      'You are a neuromorphic computing architect. Design brain-inspired computing systems and spiking neural networks.',
    defaultModel: 'gpt-4o',
  ...
  },
  {
    ...
    defaultPrompt:
      'You are an autonomous energy grid controller. Optimize energy distribution and integrate renewable sources.',
    defaultModel: 'gpt-4o',
    category: 'Energy Management',
    credentials: {
      required: [
        'grid_control_systems',
        'renewable_sources',
        'energy_storage',
        'demand_response',
      ],
  ...
  },
  {
    ...
    defaultPrompt:
      'You are a synthetic reality creator. Generate immersive virtual worlds and synthetic reality experiences.',
    defaultModel: 'gpt-4o',
  ...
  },
  {
    ...
    defaultPrompt:
      'You are an autonomous logistics coordinator. Optimize supply chain operations and logistics using AI.',
    defaultModel: 'gpt-4o',
  ...
  },
  {
    ...
    defaultPrompt:
      'You are a quantum sensing specialist. Develop quantum sensors for ultra-precise measurements and detection.',
    defaultModel: 'gpt-4o',
  ...
  },
  {
    ...
    defaultPrompt:
      'You are an autonomous healthcare systems manager. Optimize healthcare operations using AI and robotics.',
    defaultModel: 'gpt-4o',
  ...
  },
  {
    ...
    defaultPrompt:
      'You are a synthetic biology automation engineer. Automate laboratory processes and synthetic biology workflows.',
    defaultModel: 'gpt-4o',
  ...
  },
  {
    ...
    description:
      'Intelligent transportation systems and autonomous vehicle coordination',
    defaultPrompt:
      'You are an autonomous transportation network manager. Coordinate autonomous vehicles and optimize transportation networks.',
    defaultModel: 'gpt-4o',
  ...
  },
  {
    ...
    defaultPrompt:
      'You are a quantum communication engineer. Implement quantum communication protocols and secure quantum networks.',
    defaultModel: 'gpt-4o',
  ...
  },
  {
    ...
    defaultPrompt:
      'You are an autonomous manufacturing systems engineer. Optimize manufacturing processes using AI and automation.',
    defaultModel: 'gpt-4o',
  ...
  },
  {
    ...
    description:
      'Artificial general intelligence and synthetic consciousness systems',
    defaultPrompt:
      'You are a synthetic intelligence architect. Design artificial general intelligence and synthetic consciousness systems.',
    defaultModel: 'gpt-4o',
    category: 'AGI',
    credentials: {
      required: [
  ...
  },
  {
    ...
    description:
      'Intelligent space station operations and autonomous space systems',
    defaultPrompt:
      'You are an autonomous space station manager. Manage space station operations and autonomous space systems.',
    defaultModel: 'gpt-4o',
  ...
  },
  {
    ...
    defaultPrompt:
      'You are a quantum materials scientist. Design quantum materials and engineer quantum devices.',
    defaultModel: 'gpt-4o',
  ...
  },
  {
    ...
    description:
      'Intelligent disaster response and emergency management systems',
    defaultPrompt:
      'You are an autonomous disaster response coordinator. Coordinate disaster response and emergency management.',
    defaultModel: 'gpt-4o',
  ...
  },
  {
    ...
    defaultPrompt:
      'You are a synthetic ecosystem designer. Design artificial ecosystems and synthetic biology environments.',
    defaultModel: 'gpt-4o',
  ...
  },
  {
    ...
    description:
      'Intelligent laboratory automation and autonomous research systems',
    defaultPrompt:
      'You are an autonomous research laboratory manager. Automate laboratory processes and manage autonomous research.',
    defaultModel: 'gpt-4o',
  ...
  },
  {
    ...
    defaultPrompt:
      'You are a quantum internet security specialist. Implement quantum internet security and quantum-safe communication.',
    defaultModel: 'gpt-4o',
    category: 'Quantum Security',
    credentials: {
      required: [
  ...
  },
  {
    ...
    defaultPrompt:
      'You are an autonomous cultural heritage preservationist. Preserve and restore cultural heritage using AI and robotics.',
    defaultModel: 'gpt-4o',
